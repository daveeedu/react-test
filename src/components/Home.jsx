...
const Home = () => {
  const [inputValue, setInputValue] = useState(""),
    [cveNumValue, setCveNumValue] = useState("");

  const handleCardNumInputChange = (e) => {
  ...
  const handleCveNumInputChange = (event) => {
    const { value } = event.target;
    const regex = /^[0-9]*$/;
    if (regex.test(value)) {
      setCveNumValue(value);
    }
  };
    ...
    <Box className=" bg-[var(--c-white-2)] md:w-[80%]  w-[90%] pb-8 m-auto ">
      ...
      <Box className="xl:grid xl:grid-cols-3 mb-16 mauto  xl:w-[95%]">
        <Box className="xl:col-span-2 m-auto">
          ...
          <Box className="lg:mx-14 md:mx-9 mx-5 md:my-8">
            <OutlinedInput
              ...
              id="fullWidth"
              value={inputValue}
              onChange={handleCardNumInputChange}
              inputProps={{
                maxLength: 25,
              }}
              startAdornment={
          ...
          <Box className="md:flex md:justify-between  lg:mx-14 md:mx-9 mx-5 my-8">
            ...
            <Box className="md:w-[45%] w-[100%] md:flex justify-end">
              <OutlinedInput
                ...
                style={{ borderRadius: 10 }}
                value={cveNumValue}
                onChange={handleCveNumInputChange}
                inputProps={{
                  maxLength: 4,
        ...
        <Box className="relative">
          <Box className="absolute md:left-[16%] lg:left-[25%] xl:left-0 2xl:left-[7%] bottom-[60%] md:bottom-[60%] lg:bottom-[65%] xl:bottom-[50%] 2xl:bottom-[50%] z-10">
            <hr className="w-[18%] border-t-8 m-auto border-[var(--c-primary-0)] rounded-t-[3px]" />
            <Box className="bg-[url('./assets/images/mastercardBackground.png')] 2xl:w-[60%] xl:w-[80%] lg:w-[60%] md:w-[50%] w-[80%] m-auto rounded-[20px] shadow-md">
              <Box className="flex justify-between pt-8 px-6">
                <img src={IChip} alt="IChip" className="w-[23%] " />
                <img
                  src={IWifi}
                  alt="IWifi"
                  className="w-[17%] h-[30px] mt-3"
                />
              </Box>
              <Box className=" pt-20 px-6">
                <Typography className="text-[var(--text-bg)]">
                  Jonathan Michael
                </Typography>
                <span className="mr-2 text-[var(--text-bg)] font-[500] text-[23px]">
                  • • • •
                </span>
                <span className="text-[var(--text-bg)] font-[500] text-[23px]">
                  3456
                </span>
              </Box>
          ...
          <Box className="bg-[var(--c-success-0)] 2xl:w-[80%] xl:w-[100%] lg:w-[60%] md:w-[60%] w-[90%] md:mt-[25%] mt-[45%] 2xl:pt-[60%] xl:pt-[95%] lg:pt-[35%] md:pt-[45%] pt-[100%]  m-auto rounded-t-[20px] rounded-b-[20px] shadow-md relative z-0">
            <Box className="flex justify-between md:mx-10 mx-5">
              ...
              <Box className="flex gap-2">
                ...
                <span className="font-bold text-[var(--c-primary-3)]">
                  Apple
                </span>
              </Box>
            </Box>
            ...
            <Box className="flex justify-between mt-8 md:mx-10 mx-5">
              <Box className="mb-10">
                ...
                <h3 className="font-bold text-[var(--c-primary-3)] text-[29px]">
                  549.<span className="font-[500] text-[20px]">99</span>{" "}
                  <span className="font-[500] text-[20px] text-[var(--c-grey-0)]">
                    USD
                  </span>
                </h3>
              </Box>
              <img
                src={IDocket}
                alt="IDocket"
                className="mb-8 mt-3 w-[35px] h-[35px]"
              />
            </Box>
          </Box>
        </Box>
